...
func TestHTTPClient(t *testing.T) {
	...
	client := httptransport.NewClient(
		...
		encode,
		decode,
		gokithttptransport.ClientBefore(gokithttptransport.SetRequestHeader(headerKey, headerVal)),
		gokithttptransport.ClientAfter(afterFunc),
	)
...
func TestHTTPClientBufferedStream(t *testing.T) {
	...
	client := httptransport.NewClient(
		...
		encode,
		decode,
		gokithttptransport.BufferedStream(true),
	)
...
func TestClientFinalizer(t *testing.T) {
	...
	client := httptransport.NewClient(
		...
		encode,
		decode,
		gokithttptransport.ClientFinalizer(func(ctx context.Context, err error) {
...
func TestEncodeJSONRequest(t *testing.T) {
	...
	client := httptransport.NewClient(
		"POST",
		serverURL,
		gokithttptransport.EncodeJSONRequest,
...
func TestSetClient(t *testing.T) {
	...
	client := httptransport.NewClient(
		...
		encode,
		decode,
		gokithttptransport.SetClient(testHttpClient),
	).Endpoint()
